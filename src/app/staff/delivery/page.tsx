...
export default function DeliveryOrdersPage() {
  ...
  // Format Delivery Token
  const formatDeliveryToken = (id: string) => {
    return `#DEL-${id.slice(-4).toUpperCase()}`;
  };
    ...
    <div className="space-y-8 max-w-7xl mx-auto pb-12">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">
            Manage Swiggy, Zomato, Direct, and Phone Order dispatches and rider telemetry.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        ...
        <StatCard
          ...
          subtext="riders in transit / nearby"
      ...
      {/* Modal: View Dispatch Details (Phase 4) */}
