  ...
  return (
    <div className="space-y-8 max-w-7xl mx-auto pb-12">
        ...
        <div className="design-surface p-6 flex flex-col justify-between">
          <div>
            ...
            <h3 className="text-lg font-bold text-slate-900 mb-2">
              Restaurant Engine Connected
            </h3>
            <p className="text-xs text-slate-500 leading-relaxed">
              All 6 operational modules are active. POS synchronization, live table telemetry, and staff shift timers are healthy.
            </p>
          </div>
      ...
      <Modal
        ...
        subtitle="Reserve a table or record a walk-in guest."
      >
        <form onSubmit={handleBookingSubmit} className="space-y-4">
          ...
          <div className="pt-4 flex items-center justify-end gap-3 border-t border-slate-100">
            ...
            <Button
              type="submit"
              className="px-5 py-2 h-9 rounded-xl bg-[#0052ff] hover:bg-[#0046dc] text-white text-xs font-semibold shadow-sm border-none cursor-pointer"
            >
              Save Reservation
            </Button>
          </div>
